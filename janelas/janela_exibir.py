...
class ExibirVeiculos(ctk.CTkToplevel):
    def __init__(self, master=None):
        ...
        self.labelTtitulo = ctk.CTkLabel(self.frameTitulo, text='Visualizar Veiculos', font=('Open Sans', 26, 'bold'), text_color='white')
        self.labelTtitulo.pack(side='bottom')
        ...
        self.style.configure('Treeview', rowheight=40, font=('Open Sans', 12), foreground='white', backgruound="#2b2b2b")
        self.style.configure('Treeview.Hading', font=('Open Sans', 12), foreground="white", background='#2b2b2b')
