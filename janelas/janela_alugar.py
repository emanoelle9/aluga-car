...
class AlugarVeiculo(ctk.CTkToplevel):
    def __init__(self, master=None):
        ...
        self.labelPlaca.grid(row=0, column=0, padx=10, pady=(10), sticky='W')
        self.comboPlaca = ctk.CTkComboBox(self.frameItens, font=('Open Sans', 16))
        self.comboPlaca.grid(row=0, column=1, padx=10, pady=10, sticky='W')
        ...
        self.entryModelo.grid(row=1, column=1, padx=10, sticky='w')
        ...
        self.entryAno.grid(row=1, column=3, padx=10, sticky='w')
        ...
        self.entrycliente = ctk.CTkEntry(self.frameItens, font=('Open Sans', 16), width=300, state='disabled')
        self.entrycliente.grid(row=2,column=1, padx=10, sticky='w')

        self.botaoCliente = ctk.CTkButton(self.frameItens, text='Cadastrar Cliente', font=('Open Sans', 16, 'bold'), command=self.cadastrar_cliente)
        self.botaoCliente.grid(row=2, column=2, columnspan=2, padx=10, pady=10, sticky='ew')

        self.labelDataInicio = ctk.CTkLabel(self.frameItens, text="Data de inicio", font=('Open Sans', 16, 'bold'))
        ...
        self.entryDataInicio.grid(row=3, column=1, padx=10, sticky='w')
        ...
        self.entryDatafim.grid(row=3, column=3, padx=10, sticky='w')

        self.botaoAlugar = ctk.CTkButton(self.frameItens, text='Alugar', font=('Open Sans', 16, 'bold'))
        self.botaoAlugar.grid(row=4, column=0, padx=10, sticky='ew')
